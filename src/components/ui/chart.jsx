...
export function LineChart({ data, config, className }) {
  return (
    <RechartsLineChart width={600} height={300} data={data} className={className}>
      <XAxis dataKey="name" />
      <YAxis />
      <CartesianGrid strokeDasharray="3 3" />
      <Tooltip />
      <Legend />
      <Line type="monotone" dataKey={config.price.label} stroke={config.price.color} />
    </RechartsLineChart>
  );
}

// Define and export the BarChart component
export function BarChart({ data, config, className }) {
  return (
    <RechartsBarChart width={600} height={300} data={data} className={className}>
      <XAxis dataKey="name" />
      <YAxis />
      <CartesianGrid strokeDasharray="3 3" />
      <Tooltip />
      <Legend />
      <Bar dataKey={config.listings.label} fill={config.listings.color} />
    </RechartsBarChart>
  );
}
